...
@app.route("/tasks")
def tasks():
    view_tasks = list(Task.query.order_by(Task.task_name).all())
    return render_template("tasks.html", tasks=view_tasks)
...
def edit_task(task_id):
    ...
    return render_template("edit-task.html", task=task, categories=categories)
